...
public class WordNet {
	...
	public WordNet() {
		...
		ignorelist.put("state", "country");
	}
	public static HashMap<String,String> ignorelist=new HashMap<String,String>();
	public static boolean isSynset(String str1, String str2) {
		String s=ignorelist.get(str1);
		if(s!=null&&s.equals(str2)) return false;
