...
public class BlackList {
	...
	static {
		...
		predicateSet.add("http://dbpedia.org/ontology/wikiPageRevisionID");
		predicateSet.add("http://dbpedia.org/ontology/type");
		...
		predicateSet.add("http://dbpedia.org/property/type");
	}
	
	public static boolean isblacked(String str) {
		for (String tmp:predicateSet) {
